...
require (
	...
	github.com/antinvestor/apis/go/chat v1.48.16
...
require (
	...
	buf.build/gen/go/antinvestor/notification/protocolbuffers/go v1.36.10-20251119161822-0f712795b762.1 // indirect
